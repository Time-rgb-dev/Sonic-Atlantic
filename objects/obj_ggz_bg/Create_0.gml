/// @description Add background
	...
	add_background(spr_bg_ggz_sky, 0, 0.9, v_scroll, -0.2, 0, 0, 50);
	add_background(spr_bg_ggz_sky, 1, 0.93, v_scroll, -0.15, 0, 0, 50);
	add_background(spr_bg_ggz_sky, 2, 0.95, v_scroll, -0.1, 0, 0, 50);
	add_background(spr_bg_ggz_sky, 3, 0.97, v_scroll, -0.05, 0, 0, 50);
	add_background(spr_bg_ggz_sky, 4, 0.99, v_scroll, 0, 0, 0, 50);
	
	add_background_line(spr_bg_ggz_water, 0, 0.94, v_scroll, 0, 0, 0, 178, 2, 0.003);
	
	add_background(spr_bg_ggz_mountains, 0, 0.98, v_scroll, 0, 0, 0, 130);
	add_background(spr_bg_ggz_mountains, 1, 0.94, v_scroll, 0, 0, 0, 130);
	add_background(spr_bg_ggz_bottom, 4, 1, v_scroll, 0, 0, 0, 214);
	add_background(spr_bg_ggz_bottom, 2, 0.84, v_scroll, 0, 0, 0, 194);
	add_background(spr_bg_ggz_bottom, 0, 0.8, v_scroll, 0, 0, 0, 194);
	add_background(spr_bg_ggz_bottom, 1, 0.78, v_scroll, 0, 0, 0, 194);
	add_background(spr_bg_ggz_bottom, 3, 0.72, v_scroll, 0, 0, 0, 194);
	add_background(spr_bg_ggz_bottom, 5, 1, 1, 0, 0, 0, 0, false);
